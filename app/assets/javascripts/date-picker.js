...
function Datepicker($module, config) {
  ...
  this.$module = $module
  this.$input = $module.querySelector('.hmpps-js-datepicker-input')
  this.$calendarButton = $module.querySelector('.hmpps-js-datepicker-button')
}
...
Datepicker.prototype.createDialogMarkup = function (titleId) {
  return `<div class="hmpps-datepicker__dialog__header ">
        ...
        <h2 id="${titleId}" class="hmpps-datepicker__dialog__title  js-datepicker-month-year govuk-heading-s" aria-live="polite">June 2020</h2>
      ...
      <table class="hmpps-datepicker__dialog__table  js-datepicker-grid govuk-body" role="grid" aria-labelledby="${titleId}">
      <caption class="hmpps-datepicker__dialog__table-caption govuk-body">You can use the arrow keys to select a date</caption>
      <thead>
          <tr>
